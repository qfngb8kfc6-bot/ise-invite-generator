...
export default function GeneratorPage() {
  ...
  const token = useMemo(() => {
    return normaliseToken(searchParams.get('token'))
  }, [searchParams])
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-6 rounded-2xl bg-zinc-50 p-4">
            ...
            <div className="mt-3 space-y-2 text-xs text-zinc-600">
              <p>
                <strong>ID:</strong> {verifiedExhibitor.id}
              </p>
              <p>
                <strong>Company:</strong> {verifiedExhibitor.companyName}
              </p>
              <p>
                <strong>Stand:</strong> {verifiedExhibitor.standNumber}
              </p>
              <p>
                <strong>Invitation code:</strong> {verifiedExhibitor.invitationCode}
              </p>
              <p className="break-all">
                <strong>Registration URL:</strong> {verifiedExhibitor.registrationUrl}
              </p>
              <p>
                <strong>Theme:</strong> {verifiedExhibitor.theme}
              </p>
              <p>
                <strong>Language:</strong> {verifiedExhibitor.language}
              </p>
            </div>
          </div>
        </section>
