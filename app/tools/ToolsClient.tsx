...
const toolsText: Record<LanguageKey, ToolsText> = {
  ...
  ca: {
    ...
    exhibitorId: 'ID del expositor',
    exhibitorIdPlaceholder: 'p. ej. 1001',
    lookupExhibitor: 'Cercar expositor',
    lookingUp: 'Buscando...',
    generateLaunchLink: 'Generar enlace de acceso',
    generating: 'Generando...',
    companyName: 'Nombre de empresa',
...
export default function ToolsClient() {
  ...
  return (
    <main className="min-h-screen px-3 py-5 text-white sm:px-6 sm:py-6 lg:px-8">
      <div className="fade-in-up mx-auto max-w-7xl space-y-5 sm:space-y-6">
        <header className="premium-card rounded-3xl p-5 sm:p-6">
