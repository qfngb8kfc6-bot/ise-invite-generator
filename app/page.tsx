...
export default function HomePage() {
  return (
    <main className="min-h-[calc(100vh-92px)] overflow-hidden px-6 py-16 text-white">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <h1 className="mt-8 max-w-4xl text-5xl font-semibold leading-[0.95] tracking-[-0.06em] text-white sm:text-7xl">
        ...
        <div className="mt-12 grid w-full gap-4 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-black/46 p-6 text-left shadow-[0_18px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl">
