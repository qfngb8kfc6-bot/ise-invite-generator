...
function InsightCard({
  ...
  return (
    <div className={`rounded-2xl border p-5 shadow-sm ${toneClasses[tone]}`}>
      <div className={`text-sm font-medium ${subToneClasses[tone]}`}>{title}</div>
      <div className="mt-2 text-3xl font-semibold">{value}</div>
      <p className={`mt-2 text-sm ${subToneClasses[tone]}`}>{subtitle}</p>
    </div>
  )
}
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-neutral-600">
              Exhibitor detail analytics view
            </p>
        ...
        <section className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            ...
            <div className="mt-2 text-3xl font-semibold">{exhibitor.totalEvents}</div>
          </div>

          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="text-sm text-neutral-500">Links Generated</div>
            <div className="mt-2 text-3xl font-semibold">{exhibitor.linkGeneratedCount}</div>
          </div>

          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="text-sm text-neutral-500">Generator Opens</div>
            <div className="mt-2 text-3xl font-semibold">{exhibitor.generatorOpenedCount}</div>
          </div>

          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="text-sm text-neutral-500">Exports Succeeded</div>
            <div className="mt-2 text-3xl font-semibold">{exhibitor.exportSucceededCount}</div>
          </div>

          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="text-sm text-neutral-500">Exports Failed</div>
            <div className="mt-2 text-3xl font-semibold">{exhibitor.exportFailedCount}</div>
          </div>

          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="text-sm text-neutral-500">Open → Export</div>
            <div className="mt-2 text-3xl font-semibold">
              {percentage(exhibitor.exportSucceededCount, exhibitor.generatorOpenedCount)}
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold">Exhibitor summary</h2>
            <p className="mt-1 text-sm text-neutral-500">
              Core engagement and status for this exhibitor.
            </p>

            <div className="mt-4 space-y-3 text-sm text-neutral-700">
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
                <span>Company name</span>
                <span className="font-medium">{exhibitor.companyName}</span>
              </div>
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
                <span>Exhibitor ID</span>
                <span className="font-medium">{exhibitor.exhibitorId}</span>
              </div>
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
                <span>Session verified</span>
                <span className="font-medium">{exhibitor.sessionVerifiedCount}</span>
              </div>
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
                <span>Export clicked</span>
                <span className="font-medium">{exhibitor.exportClickedCount}</span>
              </div>
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
              ...
              <div className="flex items-center justify-between gap-4 rounded-xl border bg-neutral-50 px-4 py-3">
                ...
                <span className="font-medium">{formatDate(exhibitor.lastActivityAt)}</span>
              </div>
            </div>
          </div>
