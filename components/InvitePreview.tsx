  ...
  switch (language) {
    case 'es':
      return {
        ...
        freeCode: 'Ahorra 300 € y consigue hoy tu entrada gratuita',
      }
    ...
    case 'fr':
      return {
        ...
        freeCode: 'Économisez 300 € et obtenez votre badge gratuit dès aujourd’hui',
      }
    ...
    case 'de':
      return {
        ...
        freeCode: 'Sparen Sie 300 € – sichern Sie sich jetzt Ihr kostenloses Ticket!',
      }
    ...
    case 'it':
      return {
        ...
        freeCode: 'Risparmia 300 € ed assicurati oggi il tuo biglietto',
      }
      ...
      <section className="h-[710px] bg-white px-12 py-10 text-[#050b36]">
        ...
        <div className="grid h-[540px] grid-cols-[minmax(0,1fr)_300px] gap-11 pt-9">
          <div className="min-w-0">
            ...
            {language === 'en' ? (
              <div className="mt-8 max-w-[640px] space-y-3 text-[16.5px] font-medium leading-[1.38] text-[#050b36]">
              ...
              <div className="mt-8 max-w-[640px] space-y-3 text-[19px] font-medium leading-[1.34] text-[#050b36]">
                {cardCopy.bodyOne}
