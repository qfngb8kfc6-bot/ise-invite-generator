      ...
      <div className="grid h-full lg:grid-cols-[420px_1fr]">
        <aside className="flex h-full min-h-0 flex-col border-r border-white/10 bg-[#050816]/95">
          ...
          <div className="border-t border-white/10 bg-black/30 p-5">
            <div className="grid grid-cols-2 gap-3">
              <button disabled={isExporting} onClick={() => runExport('square')} className="rounded-2xl bg-blue-600 py-4 font-semibold disabled:opacity-50">PNG Square</button>
              <button disabled={isExporting} onClick={() => runExport('pdf')} className="rounded-2xl border border-white/10 bg-white/5 py-4 font-semibold disabled:opacity-50">Export PDF</button>
              <button disabled={isExporting} onClick={() => runExport('linkedin')} className="rounded-2xl border border-white/10 bg-white/5 py-4 font-semibold disabled:opacity-50">LinkedIn</button>
              <button disabled={isExporting} onClick={() => runExport('zip')} className="rounded-2xl border border-white/10 bg-white/5 py-4 font-semibold disabled:opacity-50">ZIP Pack</button>
            </div>
